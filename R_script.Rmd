...
cv_foha_color1 <- cv(fohanasity_traits$color_pca1)
cv_foha_color2 <- cv(fohanasity_traits$color_pca2)
cv_guave_color1 <- cv(guave_traits$color_pca1)
cv_kalafam_color1 <- cv(kalafam_traits$color_pca1)
cv_kalafana_color1 <-cv(kalafana_traits$color_pca1)
cv_kalafana_color2 <-cv(kalafana_traits$color_pca2)
cv_vandrika_color1 <-cv(vandrika_traits$color_pca1)
cv_vandrika_color2 <-cv(vandrika_traits$color_pca2)
cv_voara_color1 <-cv(voara_traits$color_pca1)
cv_voara_color2 <-cv(voara_traits$color_pca2)
```
...
# Farbpalette für die Individuen festlegen
